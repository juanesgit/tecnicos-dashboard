...
from app.routers import auth, datos, feedback, push, users, usuarios, zonas, historico, avance, productividad, admin, actividad, alarmas, causas, jefe
...
app.include_router(causas.router,      prefix="/api")
app.include_router(jefe.router,        prefix="/api")
