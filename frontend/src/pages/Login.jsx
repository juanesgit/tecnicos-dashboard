  ...
  return (
    ...
    >
      <div className="w-full max-w-xs">
        ...
        >
          <h2 className="font-semibold text-sm mb-4 text-white text-center tracking-wide">Iniciar sesión</h2>

          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label className="block text-xs font-medium mb-1" style={{ color: '#FFFFFF' }}>
                Usuario
              </label>
              <input
                type="text"
                ...
                className="w-full px-3 py-2 rounded-lg text-xs text-white placeholder-white/20 focus:outline-none transition-all"
                style={{
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full font-semibold py-2 rounded-lg transition-all flex items-center justify-center gap-2 text-white mt-1 text-xs"
        ...
        <p className="text-center mt-4" style={{ fontSize: '0.65rem', color: 'rgba(160,150,198,0.4)' }}>
